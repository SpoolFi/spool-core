...
```solidity
function pool() external view returns (contract IHarvestPool)
```
...
| Name | Type | Description |
|---|---|---|
| _0 | contract IHarvestPool | undefined
...
```solidity
function vault() external view returns (contract IHarvestVault)
```
...
| Name | Type | Description |
|---|---|---|
| _0 | contract IHarvestVault | undefined
