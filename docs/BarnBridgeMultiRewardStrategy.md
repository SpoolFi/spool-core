...
```solidity
function rewardPool() external view returns (contract IPoolMulti)
```
...
| Name | Type | Description |
|---|---|---|
| _0 | contract IPoolMulti | undefined
...
```solidity
function yield() external view returns (contract ISmartYield)
```
...
| Name | Type | Description |
|---|---|---|
| _0 | contract ISmartYield | undefined
