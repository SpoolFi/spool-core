...
contract NotionalStrategy is ClaimFullSingleRewardStrategy {
    ...
    constructor(
        ...
        ClaimFullSingleRewardStrategy(_note) 
    {
        ...
        require(_nToken == _strategyHelper.nToken(), "NotionalStrategy::constructor: nToken is not the same as helpers nToken");
    ...
    function _deposit(uint128 amount, uint256[] memory slippages) internal override returns(uint128) {
        ...
        require(
            nTokenBalanceNew >= slippage,
            "NotionalStrategy::_deposit: Insufficient nToken Amount Minted"
        );
    ...
    function _withdraw(uint128 shares, uint256[] memory slippages) internal override returns(uint128) {
        ...
        require(
            ...
            "NotionalStrategy::_deposit: Insufficient withdrawn amount"
        );
